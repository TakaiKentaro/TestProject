...
//namespace TreeNode
//{
//    //using TreeNode.ExtensionMethods;
...
//    {
//        List<TreeData> _childList; //子要素リスト

//        TreeData _parentNode; //この要素の親要素

//        Object _value; //この要素の格納値

//        char s_pathSeparator = '/'; //要素パスの区切り文字

//        bool s_ignoreCase = true; //要素名の大文字・小文字の区別
...
//            this._childList = new List<TreeData>();
//            this.m_value = null;
//            this.NodeType = NodeType.NO_DATA;
//        }
...
//        /// <exception cref="TreeNode.TreeDataException">
//        /// 要素名に区切り文字を使用しないこと</exception>
//        public TreeData(String name, NodeType type, Object data)
//            : this(name, type)
//        {
//            this.m_value = data;
//        }
...
//            get
//            {
//                if (this.NodeType == NodeType.NO_DATA)
//                {
...
//        {
//            get { return this._childList.Count; }
//        }
...
//        /// 
//        /// <seealso cref="TreeNode.NodeType"/>
...
//        /// <exception cref="TreeNode.TreeDataException">
//        /// 要素名が重複</exception>
//        public void AddChild(String name, NodeType type, Object value = null)
//        {
...
//        /// <exception cref="TreeNode.TreeDataException">
//        /// 要素名が重複</exception>
//        public void AddChildByPath(String path, NodeType type, Object value = null)
//        {
...
//        {
//            String msg;
//            if (node.NodeType == NodeType.NO_DATA)
//            {
//                msg = String.Format("Name:{0},", node.Name);
//            }
//            else
//            {
//                String valueStr = (node.Value == null)
//                                  ? "null" : node.Value.ToString();
...
//        /// <summary>親要素に指定する子要素を追加する</summary>
//        private static void __AddChild(TreeData parent, String name, NodeType childNodeType, Object value = null)
//        {
...
//        private static void __AddChildByPath(TreeData parent, String path, NodeType type, Object value)
//        {
...
//                if (node[child] == null)
//                {
//                    __AddChild(node, child, NodeType.NO_DATA);
//                }
//                node = node[child];
//            }
